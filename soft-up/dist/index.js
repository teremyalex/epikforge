...
const hero1 = new IntersectionObserver(entries => {
    entries.forEach(entry => {
        if (entry.isIntersecting) {
            ...
            document.getElementById('hero1-circle1').style.transform = 'scale(1)';
            document.getElementById('hero1-circle2').style.transform = 'scale(1)';
        }
    });
});
...
const hero5 = new IntersectionObserver(entries => {
    entries.forEach(entry => {
        if (entry.isIntersecting) {
            document.getElementById('hero5-img').style.transform = 'translateY(0)';
            document.getElementById('hero5-circle1').style.transform = 'scale(1)';
            document.getElementById('hero5-circle2').style.transform = 'scale(1)';
        }
    });
});
